		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a class="nav-link"
					href="reservasCliente">Mis reservas<span class="sr-only">(current)</span></a>
				</li>
			</ul>
						...
						<tbody>
							...
							<tr>
								...
								<form action="detalleReserva" method="post">
									<td><button type="submit" class="btn btn-info btn-sm">Ver
											detalle</button> <input type="hidden" name="idreserva"
										value="<%=r.getIdReserva()%>" /></td>
								</form>
							</tr>
							<%
							}
